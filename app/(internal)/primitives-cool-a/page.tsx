...
/**
 * Cool palette — CANDIDATE A (Mist & Volt). Same demo as /primitives, with the
 * candidate-A token overrides loaded via globals-cool-a.css. Source of truth:
 * design-system/MASTER.cool-candidate-A.md.
 */

const STAGES: Stage[] = ["empires", "builders", "bootstrappers"];

export default function PrimitivesCoolADemo() {
  return (
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        <header>
          <p className="text-label uppercase tracking-wider text-pen">
            Catalst Market — Cool Candidate A
          </p>
          <h1 className="font-serif text-h1 md:text-hero text-ink leading-none mt-3">
            Mist &amp; Volt
          </h1>
          <p className="text-body text-pen mt-3 max-w-2xl">
            Cool-system override of the warm-editorial baseline. Paper shifts to
            silver-mist, ink to indigo-black, CTA to Volt Scarlet
            <code className="font-mono text-sm bg-card px-1.5 py-0.5 rounded-sm border border-rule mx-1">
              #FF2D55
            </code>
            (Apple iOS system red hue). Compare side-by-side with{" "}
            <a className="underline" href="/primitives">/primitives</a> (warm baseline) and{" "}
            <a className="underline" href="/primitives-cool-b">/primitives-cool-b</a> (Candidate B).
          </p>
        </header>
